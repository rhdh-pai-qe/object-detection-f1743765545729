...
3) Access the `workbench` named `object-detection-f1743765545729-notebook`.
...
5) In the terminal, run `cd object-detection-f1743765545729` to navigate to your sample app's directory.
